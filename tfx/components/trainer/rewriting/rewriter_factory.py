...
def create_rewriter(rewriter_type, *args, **kwargs):
  ...
  Returns:
    The instantiated rewriter or None of the type is not found.
  """
  for c in rewriter.BaseRewriter.__subclasses__():
    if (c.__name__.lower()) == rewriter_type.lower():
      return c(*args, **kwargs)
  logging.error("Failed to find rewriter: %s", rewriter_type)
  return None
